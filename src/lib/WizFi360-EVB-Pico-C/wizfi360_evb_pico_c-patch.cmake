...
set(CMSIS_5_SRC_DIR "${CMAKE_SOURCE_DIR}/external/CMSIS_5")
set(CMSIS_DRIVER_SRC_DIR "${CMAKE_SOURCE_DIR}/external/CMSIS-Driver")
set(CMSIS_FREERTOS_SRC_DIR "${CMAKE_SOURCE_DIR}/external/CMSIS-FreeRTOS")
set(IOT_SOCKET_SRC_DIR "${CMAKE_SOURCE_DIR}/external/IoT_Socket")
set(MBEDTLS_SRC_DIR "${CMAKE_SOURCE_DIR}/external/CMSIS-Driver")
set(PICO_EXTRAS_SRC_DIR "${CMAKE_SOURCE_DIR}/external/pico-extras")
set(PICO_SDK_SRC_DIR "${CMAKE_SOURCE_DIR}/external/pico-sdk")
set(PICO_SDK_TINYUSB_SRC_DIR "${CMAKE_SOURCE_DIR}/external/lib/tinyusb")
set(WIZFI360_EVB_PICO_C_PATCH_DIR "${CMAKE_SOURCE_DIR}/patches")
